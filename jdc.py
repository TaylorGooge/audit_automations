...
report_name = "JDC-Test_Court_Audit.xlsx"
...
militaryreport_str = ["CaseID", "Clerk Case Number", "ClientID", "FullName", "Gender", "Race", "DOB", "CaseManager",
                      ...
                      "Veterans Association Membership", "Disability Compensation from VA",
                      "Military-Related Mental Illness", "Vet Center Utilization", "Veteran Mentor Assigned",
                      "Veteran Mentor Name", "Veteran Mentor Assigned Date"
                      ]
...
pregnancy_str = ["CaseManager", "Clerk Case Number", "FullName", "Judge", "ChildDOB", "Gender",
