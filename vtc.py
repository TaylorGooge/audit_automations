...
report_name = "VTC-Test_Court_Audit.xlsx"
# ----------------------------------------------DONT CHANGE ANYTHING BEYOND THIS POINT---------------------------------------------------


# -------------------------------Declare Queries----------------------------------
caselist_str = ["Age at Screening", "Current Age", "Days From Acceptance to SA Treatment",
                "Sentence/Disposition at Screening", "Primary Offense Charge Code", "Days From Arrest to SA Treatment",
                "Days In Jail", "Days In Jail By Bench Warrant",
                "Days In Jail By Drug Court Sanction", "Days In Jail By New Offense", "Days In Jail By Pre-Admission",
                "Days of 12 Step Program", "Days Rearrested in Program",
                ...
                "Number of Days in Phase III", "Number of Days in Phase IV", "Number of Days in Phase IV",
                "Number of Felonies", "CaseStatus", "Number of Incentives",
                "Number of Monitoring with Contact Made - No Violation", "Number of Overall Positive Drug Tests",
                "Number of Other Offense",
                ...
                "SA Outpatient Detox", "SA Residential", "SA Sub Acute Detox",
                ...
                "Drivers License Status", "Convicted Offense Category in Program", "FullName", "CourtID", "ADDRESS",
                "CaseID", "Prior Subsance Abuse Treatment"]

caseinformation_str = ["ScreeningID", "LastName", "FirstName", "MiddleName", "DOB", "DrugCourtApproach",
                       "PrimaryOffense", "Counts", "OffenseCategory", "OffenseType", "OffenseDate", "IncidentOffense",
                       "ArrestDate", "FirstAppearanceDate", "ArraignmentDate", "PreliminaryHearingDate",
                       "PretrialHearingDate", "CustodyStatus", "BloodAlcoholContent", "IsWeaponUsed",
                       "AdjudicationDate", "ProbationExpirationDate", "Sentence",
...
militaryreport_str = ["CaseID", "Clerk Case Number", "ClientID", "FullName", "Gender", "Race", "DOB", "CaseManager",
                      ...
                      "Veteran Mentor Assigned", "Veteran Mentor Assigned Date"
                      ]
...
pregnancy_str = ["CaseManager", "Clerk Case Number", "FullName", "Judge", "Gender", "ChildDOB",
                 ...
                 "PharmacologicalIntervention", "PharmacologicalInterventionComment",
...
suspension_str = ["Clerk Case Number", "CaseStatus","DaysSuspended", "ActivatedDate","CaseManager","Race",
                  "AdmissionDate","FullName","CasePhase","Gender", "DischargeDate", "DischargeReason","DOB", "Judge"]
